import { NGO_INSIGHT_SCHEMA_DESCRIPTION, normalizeNgoInsightResult } from "./ngoInsightSchema.js";
...
function buildPrompt(websiteUrl) {
  return `Analyze the following NGO website and generate a detailed intelligence report for UnityNet.
        ...
        messages: [
          {
            role: "system",
            content:
              "You are an expert NGO intelligence analyst for UnityNet. You generate structured JSON reports about NGOs to help volunteers, donors, CSR teams, and partner organizations make informed decisions. Always respond with valid JSON only. No markdown. No explanation outside JSON.",
          },
          {
            role: "user",
