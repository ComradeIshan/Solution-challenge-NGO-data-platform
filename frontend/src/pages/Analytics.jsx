  ...
  return (
    ...
    >
      ...
      >
        ...
        {suffix && (
          <span style={{ fontFamily: T.ff, fontSize: "18px", color: T.g400 }}>
            {suffix}
          </span>
        )}
      </div>
...
const GROWTH_VOL = [
  1200, 2100, 2800, 3600, 4200, 5100, 6300, 7200, 8800, 10400, 12100, 14800,
];
            ...
            {["volunteers", "ngos"].map((t) => (
              <button
                ...
                style={{
                  ...
                  cursor: "pointer",
                  boxShadow:
                    active === t ? "0 1px 4px rgba(0,0,0,0.08)" : "none",
          ...
          {MONTHS.map((m, i) => (
            <span
              ...
              style={{
                fontFamily: T.fb,
                fontSize: "9.5px",
                color: i % 2 === 0 ? T.g400 : "transparent",
                letterSpacing: "0.2px",
              }}
            >
              {m}
        ...
        >
          {[
            { l: "Peak month", v: formatNum(max) },
            {
              l: "Avg / month",
              v: formatNum(
                Math.round(data.reduce((a, b) => a + b) / data.length),
              ),
            },
            {
              l: "YTD growth",
              v: `+${Math.round(((data[11] - data[0]) / data[0]) * 100)}%`,
            },
          ].map((s) => (
            <div key={s.l}>
              <p
    ...
    <GlassCard style={{ padding: "28px 28px 20px", flex: "1 1 0" }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: "14px" }}>
          {[
            { color: T.blue, label: "Matches" },
            { color: T.green, label: "Campaigns" },
          ].map((l) => (
            <div
              key={l.label}
            ...
            >
              ...
              />
              <span
                style={{ fontFamily: T.fb, fontSize: "11px", color: T.g500 }}
              >
                {l.label}
              </span>
            </div>
      ...
      >
        <div style={{ display: "flex", gap: "24px" }}>
          {[
            ...
            {
              l: "Total campaigns",
              v: MONTHLY_ACT.reduce((a, b) => a + b.camps, 0).toString(),
            },
          ].map((s) => (
            <div key={s.l}>
              <p
  ...
  return (
    <div ref={ref} style={{ marginBottom: "14px" }}>
      ...
      >
        ...
        <span style={{ fontFamily: T.fb, fontSize: "12px", color: T.g400 }}>
...
function IndiaNeedMap() {
  ...
  useEffect(() => {
    ...
    const initMap = () => {
      if (!mapRef.current || !window.google?.maps || initializedRef.current)
        return;
    ...
    const existingScript = document.getElementById(
      "google-maps-script-DigitalSevaks",
    );

    const handleLoad = () => initMap();
    const handleError = () => {
      setMapError(
        "Google Maps failed to load. Add your API key in Analytics.jsx.",
      );
    };
    ...
    script.id = "google-maps-script-DigitalSevaks";
    script.async = true;
    script.defer = true;
    script.src =
      "https://maps.googleapis.com/maps/api/js?key=AIzaSyA7dcBYHl72IYgR8vxFqr5q6-H0r9dE-sE";
  ...
  const activity = [
    {
      icon: "🙋",
      iconBg: T.blueLight,
      text: "3 volunteers joined — Bengaluru chapter",
      time: fmt(new Date(now - 4 * 60000)),
      accent: { label: "New", color: T.blueMid, bg: T.blueLight },
    },
    {
      icon: "🏢",
      iconBg: T.greenLight,
      text: "Asha Foundation NGO registered",
      time: fmt(new Date(now - 11 * 60000)),
      accent: { label: "NGO", color: T.greenMid, bg: T.greenLight },
    },
    {
      icon: "🎯",
      iconBg: T.purpleLight,
      text: "AI matched 7 volunteers → Clean Ganga",
      time: fmt(new Date(now - 28 * 60000)),
      accent: { label: "Match", color: T.purple, bg: T.purpleLight },
    },
    {
      icon: "✅",
      iconBg: T.tealLight,
      text: "Literacy Drive campaign completed",
      time: fmt(new Date(now - 52 * 60000)),
      accent: { label: "Done", color: T.teal, bg: T.tealLight },
    },
    {
      icon: "❤️",
      iconBg: "#fce7f3",
      text: "+42 beneficiaries reached in Odisha",
      time: fmt(new Date(now - 1.5 * 3600000)),
      accent: null,
    },
    {
      icon: "📊",
      iconBg: T.amberLight,
      text: "Monthly impact report auto-generated",
      time: fmt(new Date(now - 3 * 3600000)),
      accent: null,
    },
    {
      icon: "🌱",
      iconBg: T.greenLight,
      text: "Reforestation campaign — 800 saplings",
      time: fmt(new Date(now - 5 * 3600000)),
      accent: { label: "Impact", color: T.greenMid, bg: T.greenLight },
    },
  ];
      ...
      >
        ...
        >
          ...
          <GlassCard style={{ padding: "24px" }}>
            ...
            >
              Google Maps India view with highlighted regions where NGO support
              is needed most
            </p>
            <IndiaNeedMap />
            {/* legend */}
            ...
            >
              <span
                style={{ fontFamily: T.fb, fontSize: "10px", color: T.g400 }}
              >
                Less
              </span>
              {["#f0f0f0", T.greenLight, "#86efac", "#4ade80", "#16a34a"].map(
                (c) => (
                  <div
                    key={c}
                    style={{
            ...
            {[
              {
                ...
                value: 9240,
                max: 9240,
                color: `linear-gradient(90deg,${T.blue},${T.blueMid})`,
              },
              {
                label: "Karnataka",
                value: 7820,
                max: 9240,
                color: `linear-gradient(90deg,${T.green},${T.greenMid})`,
              },
              {
                label: "Tamil Nadu",
                value: 6440,
                max: 9240,
                color: `linear-gradient(90deg,${T.teal},#0891b2)`,
              },
              {
                label: "Delhi NCR",
                value: 5880,
                max: 9240,
                color: `linear-gradient(90deg,${T.purple},#6366f1)`,
              },
              {
                label: "West Bengal",
                value: 4210,
                max: 9240,
                color: `linear-gradient(90deg,${T.amber},#f97316)`,
              },
              {
                label: "Andhra Pradesh",
                value: 3560,
                max: 9240,
                color: `linear-gradient(90deg,#f43f5e,#fb923c)`,
              },
            ].map((r) => (
