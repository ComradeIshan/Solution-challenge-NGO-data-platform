...
const AUDIENCES = [
  {
    ...
    sub: "Stop losing weeks to manual volunteer coordination. UnityNet gives your team the tools to find, vet, onboard, and measure — automatically.",
    ...
    testimonial: {
      quote: "We went from 200 to 4,000 volunteers in six months. The dashboard gave our board the evidence to unlock a $2M grant.",
      name: "James Mwangi",
  ...
  },
  {
    ...
    testimonial: {
      quote: "UnityNet surfaced a farm-irrigation project in Ghana in under 30 seconds. Six months later I'm tech lead across 14 countries.",
      name: "Sofia Lima",
...
// ─── Tiny benefit card ──────────────────────────────────────────────────────────
function BenefitCard({ benefit, accent, accentLight, index, inView, panelHovered }) {
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "10px" }}>
          <motion.div
            animate={hov ? { scale: 1.1, rotate: [0, -6, 6, 0] } : { scale: 1, rotate: 0 }}
            transition={hov ? { type: "spring", stiffness: 260, damping: 14 } : { duration: 0.3 }}
            style={{
          ...
          <span style={{
            ...
            color: benefit.tagAccent, background: `${benefit.tagAccent}12`,
        ...
        <div style={{
          ...
          color: T.text, marginBottom: "5px", lineHeight: 1.25,
          letterSpacing: "-0.01em",
        }}>{benefit.title}</div>

        <div style={{
          fontFamily: T.font, fontSize: "12.5px", fontWeight: 300,
  ...
  return (
    ...
    >
      <div style={{
        ...
        lineHeight: 0.7, userSelect: "none",
      }}>"</div>
      <p style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        <div style={{
          ...
          color: testi.avatarText, flexShrink: 0,
        }}>{testi.avatar}</div>
        <div>
          <div style={{ fontFamily: T.font, fontSize: "12px", fontWeight: 700, color: T.text }}>{testi.name}</div>
          <div style={{ fontFamily: T.font, fontSize: "11px", fontWeight: 300, color: T.textMuted, marginTop: "1px" }}>{testi.role}</div>
        </div>
      </div>
    </motion.div>
  );
...
function AudiencePanel({ audience, inView, isLeft }) {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.75, delay: isLeft ? 0.1 : 0.22, ease: [0.22, 1, 0.36, 1] }}
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <motion.div
          ...
          style={{
            ...
            borderRadius: T.radiusPill, padding: "5px 13px", marginBottom: "16px",
          }}
        >
        ...
        <motion.h3
          ...
          style={{
            ...
            margin: "0 0 12px", maxWidth: "380px",
          }}
        >
          {/* Gradient first word */}
          <span style={{
        ...
        <motion.p
          ...
          animate={inView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.5, delay: isLeft ? 0.30 : 0.43 }}
          style={{
            fontFamily: T.font,
            fontSize: "clamp(13px, 1.3vw, 15px)",
            fontWeight: 300, color: T.textSub,
            lineHeight: 1.75, margin: 0, maxWidth: "400px",
          }}
        >{audience.sub}</motion.p>
      </div>
      ...
      >
        {audience.stats.map((s, i) => (
          <div key={s.label} style={{
            ...
            borderRight: i < audience.stats.length - 1 ? `1px solid ${T.border}` : "none",
          }}>
            <div style={{
              fontFamily: T.font, fontSize: "clamp(18px, 2.2vw, 24px)",
...
function PanelCTA({ label, accent, primary, onClick }) {
  ...
  return (
    <motion.button
      ...
      style={{
        x: sx, y: sy,
        fontFamily: T.font, fontSize: "13.5px", fontWeight: 600,
        ...
        letterSpacing: "0.01em",
        boxShadow: primary && hov ? `0 6px 24px ${accent}40` : primary ? `0 3px 12px ${accent}25` : "none",
...
function CenterDivider({ inView }) {
  return (
    <div style={{
      ...
      gap: "16px", flexShrink: 0, width: "48px",
      ...
      <motion.div
        ...
        transition={{ duration: 0.4, delay: 0.6, type: "spring", stiffness: 260 }}
        style={{
  ...
  return (
    <div style={{ position: "absolute", inset: 0, pointerEvents: "none", zIndex: 0, overflow: "hidden" }}>
      {[
        ...
        { x: "88%",  y: "65%",  w: 220, color: `${T.violet}07`, dur: 15, delay: 3 },
      ].map((b, i) => (
        <motion.div key={i}
          animate={{ x: [0, 26, -18, 0], y: [0, -20, 13, 0], scale: [1, 1.05, 0.97, 1] }}
...
function AudienceTabs({ active, setActive }) {
  return (
    ...
    >
      {[{ id: "ngo", label: "🏛️ For NGOs" }, { id: "volunteer", label: "🙋 For Volunteers" }].map(tab => (
        <motion.button
          key={tab.id}
          ...
          style={{
            ...
            color: active === tab.id ? (tab.id === "ngo" ? T.green : T.blue) : T.textMuted,
  ...
  return (
    ...
    >
      ...
      <h2 style={{
        ...
        }}>Two powerful paths.</span>
      </h2>

      <p style={{
        fontFamily: T.font, fontSize: "clamp(14px, 1.5vw, 17px)",
        fontWeight: 300, color: T.textSub, lineHeight: 1.75, margin: 0,
      }}>
        Whether you're mobilising volunteers or offering your skills,
        UnityNet meets you exactly where you are.
      </p>
    </motion.div>
  );
}
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "1240px", margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <AudiencePanel audience={AUDIENCES[1]} inView={inView} isLeft={false} />
        </div>
