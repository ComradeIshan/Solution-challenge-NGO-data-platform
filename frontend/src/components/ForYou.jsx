...
const AUDIENCES = [
  ...
  },
  {
    ...
    testimonial: {
      quote:
        "UnityNet surfaced a farm-irrigation project in Ghana in under 30 seconds. Six months later I'm tech lead across 14 countries.",
      name: "Sofia Lima",
  ...
  return (
    ...
    >
      ...
      <motion.div
        initial={{ opacity: 0, y: 10 }}
        animate={inView ? { opacity: 1, y: 0 } : {}}
        transition={{ duration: 0.45, delay: isLeft ? 0.72 : 0.85 }}
        style={{
          display: "flex",
          gap: "10px",
          flexWrap: "wrap",
      ...
      >
        <PanelCTA label={audience.cta} accent={accent} primary />
        <PanelCTA
...
// ─── Panel CTA button ───────────────────────────────────────────────────────────
function PanelCTA({ label, accent, primary }) {
  const ref = useRef(null);
  ...
  return (
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          Our 2-minute quiz finds the best path for your goals — NGO, volunteer,
          or donor.
        </div>
      </div>
...
function SectionHeader({ inView }) {
  return (
    ...
    >
      ...
      >
        Whether you're mobilising volunteers or offering your skills, UnityNet
