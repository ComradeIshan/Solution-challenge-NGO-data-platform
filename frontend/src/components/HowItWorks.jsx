  ...
  return (
    <div style={{ display: "flex", gap: "0px", alignItems: "stretch" }}>
      ...
      <div style={{
        ...
        alignItems: "center", width: "56px", flexShrink: 0,
      }}>
        {/* Number bubble */}
        <motion.div
          initial={{ opacity: 0, scale: 0.6 }}
          animate={inView ? { opacity: 1, scale: 1 } : {}}
          transition={{ duration: 0.4, delay: cardDelay - 0.05, type: "spring", stiffness: 260 }}
          animate2={{
          ...
          style={{
            ...
            fontFamily: T.font, fontSize: "12px", fontWeight: 800,
            color: isActive ? "#fff" : step.accent,
        ...
        {index < totalSteps - 1 && (
          <div style={{
            ...
            <motion.div
              ...
              transition={{ duration: 0.7, delay: cardDelay + 0.2, ease: "easeOut" }}
              style={{
                position: "absolute", inset: 0,
            ...
            {inView && (
              <motion.div
                ...
                transition={{ duration: 2, repeat: Infinity, ease: "easeInOut", delay: cardDelay + 0.6 }}
                style={{
      ...
      <div style={{
        ...
        <motion.div
          ...
          animate={inView
            ? { opacity: isDimmed ? 0.45 : 1, x: 0, scale: isDimmed ? 0.985 : 1 }
            : {}
          }
          transition={{
            duration: 0.6, delay: cardDelay,
            ease: [0.22, 1, 0.36, 1],
            ...
            <div style={{
              ...
              <motion.div
                ...
                style={{
                  ...
                  color: step.accent, fontFamily: T.font,
                  whiteSpace: "nowrap",
                }}
              >
        ...
        <div key={step.id} style={{ display: "flex", alignItems: "center", gap: "6px" }}>
          <motion.div
            animate={{
              ...
              boxShadow:    activeId === step.id ? `0 0 12px ${step.accent}40` : "none",
            }}
            transition={{ duration: 0.25 }}
            style={{
              display: "flex", alignItems: "center", gap: "8px",
              padding: "6px 14px", borderRadius: "50px",
              border: "1px solid", borderColor: T.borderMid,
              cursor: "default",
            }}
          >
...
function SummaryPanel({ activeId, inView }) {
  const METRICS = [
    { label: "Time from post to match",  value: "< 30 sec", accent: T.green,  icon: "⚡" },
    { label: "Volunteer match accuracy", value: "98%",       accent: T.blue,   icon: "🎯" },
    { label: "NGOs on the platform",     value: "2,900+",    accent: T.teal,   icon: "🏛️" },
    { label: "Verified impact outcomes", value: "1.2M+",     accent: T.violet, icon: "✅" },
  ];
        ...
        {METRICS.map((row, i) => (
          ...
          >
            ...
            <span style={{
              ...
              fontWeight: 800, color: row.accent,
      ...
      <AnimatePresence mode="wait">
        {activeId !== null ? (
          ...
          >
            ...
            }}>{STEPS[activeId].icon}</div>
            <div>
              <div style={{
                fontFamily: T.font, fontSize: "13px", fontWeight: 700,
                color: STEPS[activeId].accent, marginBottom: "3px",
              }}>
          ...
          >
            ...
            />
            <span style={{ fontFamily: T.font, fontSize: "13px", fontWeight: 400, color: T.textMuted }}>
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          ...
          <p style={{
            ...
            UnityNet handles the complexity so volunteers and NGOs can focus on
            what actually matters — doing good in the world.
          </p>
        </motion.div>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            ...
            <div>
              ...
              <div style={{ fontFamily: T.font, fontSize: "13px", fontWeight: 300, color: T.textSub }}>
                48,000+ volunteers matched · 2,900+ NGOs served · 1.2M lives impacted
              </div>
            </div>
          </div>

          <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
            {["No credit card", "Free forever plan", "Cancel anytime"].map(txt => (
              <div key={txt} style={{
