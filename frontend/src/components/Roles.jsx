...
function FeatureRow({ icon, text }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "10px", padding: "7px 0" }}>
      <div style={{
        width: 28, height: 28, borderRadius: "8px", background: T.g100,
      ...
      <span style={{
        fontFamily: T.fb, fontSize: "13px", color: T.g600,
...
═══════════════════════════════════════════════════════ */
function CardCTA({ label, accentColor, accentLight }) {
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        fontFamily: T.fb, fontSize: "13px", fontWeight: 600,
        ...
        boxShadow:      hov ? `0 6px 20px rgba(${
          accentColor === T.green ? "34,197,94" :
          accentColor === T.blue  ? "59,130,246" : "20,184,166"},0.32)` : "none",
        willChange: "transform",
      }}
      whileTap={{ scale: 0.96 }}
    ...
    >
        ...
        {streakVisible && (
          <motion.div
            ...
            style={{
              position:      "absolute",
              inset:         0,
              background:    "linear-gradient(108deg, transparent 30%, rgba(255,255,255,0.38) 50%, transparent 70%)",
              pointerEvents: "none",
              zIndex:        3,
              willChange:    "transform",
              x:             streakX,
      ...
      <div style={{
        ...
        <div>
          ...
          <p style={{
            fontFamily: T.fb, fontSize: "10.5px",
            color: T.g400, marginTop: "2px", lineHeight: 1,
          }}>
            {role.stat.label}
          </p>
        </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ color: T.g800, fontWeight: 500 }}>UnityNet connects you.</span>
      </motion.p>
    </motion.div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        border: `1px solid ${T.g200}`, opacity: 0.35, pointerEvents: "none",
      }} />
      <div style={{
        position: "absolute", top: "-100px", left: "50%",
        transform: "translateX(-50%)",
        width: "600px", height: "600px", borderRadius: "50%",
        border: `1px solid ${T.g200}`, opacity: 0.25, pointerEvents: "none",
      }} />
