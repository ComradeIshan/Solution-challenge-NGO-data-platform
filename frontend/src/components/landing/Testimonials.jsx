...
const TESTIMONIALS = [
  {
    id: 0,
    quote:
      "Through DigitalSevaks I applied my medical skills in rural Nepal. In three weeks our team screened 800 patients who had never seen a qualified doctor. The AI matching was uncanny — it knew my subspecialty before I'd even finished my profile.",
    name: "Dr. Riya Sharma",
  ...
  },
  {
    id: 1,
    quote:
      "Our NGO scaled from 200 to 4,000 volunteers within six months of joining. The real-time dashboard gave our board the evidence they needed to unlock a $2M grant. We simply couldn't have grown without this platform.",
    name: "James Mwangi",
  ...
  },
  {
    id: 2,
    quote:
      "As a software engineer I never imagined my code could irrigate farms in Ghana. DigitalSevaks surfaced that opportunity in under 30 seconds. Six months later I'm the tech lead for a 14-country deployment.",
    name: "Sofia Lima",
  ...
  },
  {
    id: 3,
    quote:
      "The blockchain-backed donation tracking is a game changer for institutional donors. Our compliance team went from 3-week audit cycles to same-day sign-off. We've doubled our annual giving as a direct result.",
  ...
  },
  {
    id: 4,
    quote:
      "We went from 10 local volunteers to 300 remote contributors worldwide. DigitalSevaks's automation handles onboarding, scheduling and reporting — saving our tiny team 40 hours a week.",
    name: "Priya Nair",
  ...
  },
  {
    id: 5,
    quote:
      "DigitalSevaks didn't just connect me to a cause — it connected me to a community. I've built lifelong friendships across five continents, and my skills have protected drinking water for 12,000 people.",
    name: "Claire Dupont",
...
function TestiCard({ t, index, inView, activeId, setActiveId, col }) {
  ...
  const glowBg = useTransform(
    [mouseX, mouseY],
    ([mx, my]) =>
      `radial-gradient(260px circle at ${mx}px ${my}px, ${t.accent}12, transparent 65%)`,
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          animate={
            isActive ? { scale: 1.1, opacity: 1 } : { scale: 1, opacity: 0.35 }
          }
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Thousands of volunteers, NGOs and donors trust DigitalSevaks every
            day. Here's what they say about the experience.
          </p>
        </motion.div>
